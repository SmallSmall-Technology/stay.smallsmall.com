                        ...
                        <div class="hero-form-boxes">
                            ...
                            <span class="the-locations overlay-holders">
                                <ul class="location-list-opt">
                                    <li id="Iyana Ipaja" class="location-item location-item-opt"><span class="location-icn-opt"></span> <span class="location-txt">Iyana Ipaja</span></li>
                                    <li id="Abe igi orombo local" class="location-item location-item-opt"><span class="location-icn-opt"></span> <span class="location-txt">Abe igi orombo local</span></li>
                                </ul>
                            </span>
                            <input type="hidden" name="location" class="location-val" />
                        </div>
                        <div class="hero-form-boxes">
                                        ...
                                        <div class="prop-mini-container">
                                            <div class="prop-title-details">
                                                <div class="prop-title-add">
                                                    ...
                                                    <div class="prop-addy"><?php echo $value['address'].', '.$value['city']; ?>.</div>
                                                </div>
