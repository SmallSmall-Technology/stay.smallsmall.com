				...
				<div class="payment-confirm-block">
				    <table class="payment-table">
				        <tr class="payment-tr">
				            ...
				            <td valign="top" class="payment-td">#<?php echo $details['bookingID']; ?></td>
				        </tr>
				        <tr class="payment-tr">
				        ...
				        <tr class="payment-tr">
				            <td valign="top" class="payment-td">Stayer</td>
				            <td valign="top" class="payment-td"><?php echo $details['firstname'].' '.$details['lastname']; ?></td>
				        </tr>
				        <tr class="payment-tr">
				            <td valign="top" class="payment-td">Stayer Email</td>
				            <td valign="top" class="payment-td"><?php echo $details['email']; ?></td>
				        </tr>
				        <tr class="payment-tr">
				            <td valign="top" class="payment-td">Stayer Phone</td>
				            <td valign="top" class="payment-td"><?php echo $details['phone']; ?></td>
				        </tr>
				        <tr class="payment-tr">
				            <td valign="top" class="payment-td">Stayer Address</td>
				            <td valign="top" class="payment-td"><?php echo $details['stayer_address']; ?></td>
				        </tr>
				        <tr class="payment-tr">
				            <td valign="top" class="payment-td">Numbers of Stayers</td>
				            <td valign="top" class="payment-td"><?php echo $details['guests']; ?> Stayers</td>
				        </tr>
				        <tr class="payment-tr">
        		...
        		$.ajax({
        			...
        			success	: function (data){
        				if(data == 1){
        					...
        					window.location.href = baseURL+"stayone/payment-result/"+bookingID;
